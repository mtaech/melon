...
const S = {
	card: { background: "#161b22", border: "1px solid #30363d", borderRadius: 10, padding: "12px 14px", marginBottom: 10, display: "flex", flexDirection: "column" as const, gap: 8 },
	row: { display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" as const },
	name: { fontWeight: 600, wordBreak: "break-all" as const },
	...
	pill: { fontSize: 12, padding: "2px 10px", borderRadius: 999, border: "1px solid #30363d", color: "#8b949e", marginLeft: "auto" as const },
	...
	modalWrap: { position: "fixed" as const, inset: 0, background: "rgba(1,4,9,.7)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 10 },
	modal: { background: "#161b22", border: "1px solid #30363d", borderRadius: 12, maxWidth: 620, width: "100%" as const, maxHeight: "80vh", display: "flex", flexDirection: "column" as const },
	...
	planDt: { color: "#8b949e" },
	planDd: { wordBreak: "break-all" as const, fontFamily: "ui-monospace, monospace", fontSize: 12 },
	log: { background: "#010409", border: "1px solid #30363d", borderRadius: 8, padding: 10, font: "12px/1.45 ui-monospace, monospace", maxHeight: 220, overflow: "auto" as const, whiteSpace: "pre-wrap" as const, marginTop: 10 },
	...
	empty: { color: "#8b949e", padding: 24, textAlign: "center" as const },
