...
function DashboardTab(props) {
    ...
    return React.createElement("div", null, dshRunning ? React.createElement("div", { style: S.banner }, "⚠ dsh 正在运行：升级会改动 profile 的 node_modules，请先停止 dsh 再应用升级。") : null, React.createElement("div", { style: S.header }, React.createElement("strong", null, `插件管理（${visible.length}）`), React.createElement("input", { style: S.search, placeholder: "搜索插件…", value: query, onChange: (e) => setQuery(e.target.value) }), React.createElement("button", { style: S.btn, onClick: reload }, "刷新")), loading
