...
var module = { exports: {} };
		...
		function Card({ entry, onUpgrade, onUninstall }) {
		  ...
		  return import_react.default.createElement(
		    ...
		    import_react.default.createElement("div", { style: S.desc }, entry.description ?? ""),
		    import_react.default.createElement(
		      "div",
		      { style: S.vers },
		      import_react.default.createElement("span", null, "installed ", import_react.default.createElement("b", { style: S.versB }, entry.installedVersion ?? "\u2014")),
		      import_react.default.createElement("span", null, "latest ", import_react.default.createElement("b", { style: S.versB }, latest))
		    ),
		    import_react.default.createElement(
		      "div",
		      { style: S.actions },
		      entry.url ? import_react.default.createElement("a", { href: entry.url, target: "_blank", rel: "noreferrer", style: S.link, title: entry.url }, "\u4ED3\u5E93 \u2197") : null,
		      button,
		      uninstallBtn
		    )
		  );
		...
		function DashboardTab(props) {
		  ...
		  const visible = q ? entries.filter((e) => e.name.toLocaleLowerCase().includes(q) || (e.description ?? "").toLocaleLowerCase().includes(q)) : entries;
		  ...
		  return import_react.default.createElement(
		    ...
		    import_react.default.createElement(
		      "div",
		      { style: S.header },
		      import_react.default.createElement("strong", null, `\u63D2\u4EF6\u7BA1\u7406\uFF08${visible.length}\uFF09`),
		      import_react.default.createElement(
		        "div",
		        { style: S.searchBox },
		        import_react.default.createElement("input", { style: { ...S.search, border: "none", padding: 0, flex: 1, minWidth: 0, background: "transparent", outline: "none" }, placeholder: "\u641C\u7D22\u63D2\u4EF6\u2026", value: query, onChange: (e) => setQuery(e.target.value) }),
		        query ? import_react.default.createElement("button", { style: S.clear, onClick: () => setQuery(""), title: "\u6E05\u9664\u641C\u7D22", type: "button" }, "\xD7") : null
		      ),
		      import_react.default.createElement("button", { style: S.btn, onClick: reload }, "\u5237\u65B0")
		    ),
		    loading ? import_react.default.createElement("div", { style: S.empty }, "\u67E5\u8BE2 npm registry + git \u8FDC\u7AEF\u2026") : error ? import_react.default.createElement("div", { style: S.empty }, `\u52A0\u8F7D\u5931\u8D25\uFF1A${error}`) : visible.length === 0 ? import_react.default.createElement("div", { style: S.empty }, q ? "\u65E0\u5339\u914D\u63D2\u4EF6" : "\u65E0\u63D2\u4EF6") : import_react.default.createElement("div", null, visible.map((e) => import_react.default.createElement(Card, { key: e.name, entry: e, onUpgrade: openUpgrade, onUninstall: openUninstall }))),
		...
		function UpgradeModal({ modal, onClose, onApply }) {
		  ...
		  if (plan) {
		    ...
		    else rows.push(["\u547D\u4EE4", import_react.default.createElement("code", null, plan.command)]);
		  }
